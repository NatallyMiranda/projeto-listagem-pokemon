...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if (modoEscuroEstaAtivo) {
        imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagens/imagens/imagens/sun.png");

    }
    else {
        imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagens/imagens/imagens/moon.png")
    }
});
